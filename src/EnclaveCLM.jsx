      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        {!submitted ? (
          <div>
            ...
            {complete && (
              <div style={{ background: C.white, border: `1px solid ${C.greyBorder}`, borderRadius: 8, padding: "24px 28px", marginTop: 8 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: C.navy, marginBottom: 16 }}>Get your full risk report emailed to you</div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
                  <input value={name} onChange={e => setName(e.target.value)} placeholder="Your name"
                    style={{ padding: "12px 16px", border: `1.5px solid ${C.greyBorder}`, borderRadius: 6, fontSize: 13, outline: "none", color: C.navy }} />
                ...
                <button onClick={() => { if (email && name) setSubmitted(true); }}
                  disabled={!email || !name}
                  style={{ width: "100%", background: C.navy, color: C.white, border: "none", padding: "14px", fontSize: 13, fontWeight: 700, cursor: "pointer", borderRadius: 6, letterSpacing: "0.04em", opacity: (!email || !name) ? 0.5 : 1 }}>
                  View My Risk Score
                </button>
              </div>
            )}
          ...
          <div style={{ background: C.white, border: `1px solid ${C.greyBorder}`, borderRadius: 8, padding: 40, textAlign: "center" }}>
            ...
            <div style={{ height: 6, background: C.greyBorder, borderRadius: 3, marginBottom: 28 }}>
            ...
            <a href="sms:8018222706" style={{
              ...
              📱 Text 801-822-2706 to Discuss Your Results
            </a>
          </div>
        )}
      </div>
